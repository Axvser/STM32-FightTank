...
/// @brief 设置OV2640为JPEG输出模式
void OV2640_JPEG_Mode(void);

/// @brief 设置OV2640为RGB565输出模式
void OV2640_RGB565_Mode(void);

/// @brief 设置自动曝光等级
/// @param level 曝光等级(0-4，0表示关闭自动曝光)
...
/// @brief 设置色彩饱和度
/// @param sat 饱和度等级(0-4，2为正常值)
void OV2640_Color_Saturation(uint8_t sat);

/// @brief 设置亮度
/// @param bright 亮度等级(0-4，2为正常值)
void OV2640_Brightness(uint8_t bright);

/// @brief 设置对比度
/// @param contrast 对比度等级(0-4，2为正常值)
