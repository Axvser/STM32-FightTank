...
void DCMI_DMA_Init(uint32_t DMA_Memory0BaseAddr, uint32_t DMA_Memory1BaseAddr, uint16_t DMA_BufferSize, uint32_t DMA_MemoryDataSize, uint32_t DMA_MemoryInc)
{
